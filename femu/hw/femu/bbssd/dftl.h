...
#define CMT_SIZE       (25165824ULL)  // 100% CMT
// #define CMT_SIZE       (6291456ULL)   // 25%
// #define CMT_SIZE       (12582912ULL)  // 50%
// #define CMT_SIZE       (1056964ULL)   // 4.2% CMT 
#define CMT_HASH_RATIO (43ULL)
#define CMT_HASH_SIZE  ((CMT_SIZE + CMT_HASH_RATIO - 1) / CMT_HASH_RATIO)
